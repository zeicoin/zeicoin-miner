...
void argon2_get_impl_list(argon2_impl_list *list)
{
    static const argon2_impl IMPLS[] = {
        ...
        { "SSE2",       zenrx_ar2_check_sse2,     zenrx_ar2_fill_segment_sse2 },
        { "SSSE3",      zenrx_ar2_check_ssse3,    zenrx_ar2_fill_segment_ssse3 },
        { "XOP",        zenrx_ar2_check_xop,      zenrx_ar2_fill_segment_xop },
        { "AVX2",       zenrx_ar2_check_avx2,     zenrx_ar2_fill_segment_avx2 },
        { "AVX-512F",   zenrx_ar2_check_avx512f,  zenrx_ar2_fill_segment_avx512f },
    };
